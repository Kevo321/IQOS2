...
import com.digitas.bubblepicker.model.BubbleGradient
import com.digitas.bubblepicker.model.PickerItem
import com.digitas.bubblepicker.physics.CircleBody
import com.digitas.bubblepicker.rendering.BubbleShader.U_MATRIX
import com.digitas.bubblepicker.toTexture
...
data class Item(val pickerItem: PickerItem, val circleBody: CircleBody) {
    ...
    private fun drawImage(canvas: Canvas) {
        pickerItem.backgroundImage?.let {
            val height = (it as Drawable).intrinsicHeight.toFloat()
            val width = (it as Drawable).intrinsicWidth.toFloat()
