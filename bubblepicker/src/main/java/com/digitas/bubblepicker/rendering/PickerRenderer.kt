package com.digitas.bubblepicker.rendering

import android.opengl.GLES20
import android.opengl.GLES20.*
import android.opengl.GLSurfaceView
import android.view.View
import com.digitas.bubblepicker.*
import com.digitas.bubblepicker.model.Color
import com.digitas.bubblepicker.model.PickerItem
import com.digitas.bubblepicker.physics.Engine
import com.digitas.bubblepicker.rendering.BubbleShader.A_POSITION
import com.digitas.bubblepicker.rendering.BubbleShader.A_UV
import com.digitas.bubblepicker.rendering.BubbleShader.U_BACKGROUND
import com.digitas.bubblepicker.rendering.BubbleShader.fragmentShader
import com.digitas.bubblepicker.rendering.BubbleShader.vertexShader
...
class PickerRenderer(val glView: View) : GLSurfaceView.Renderer {
    ...
    var bubbleRadiouses: Array<Int>? = null
    ...
    private fun initialize() {
        ...
        Engine.build(items.size, bubbleRadiouses, scaleX, scaleY).forEachIndexed { index, body ->
    ...
    private fun drawFrame() {
        ...
        glUniform4f(glGetUniformLocation(programId, U_BACKGROUND), 0f, 0f, 0f, 0f)
