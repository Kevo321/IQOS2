...
fun  VideoSplashScreen(navController: NavHostController){
    SplashScreen(RawResourceDataSource.buildRawResourceUri(R.raw.splash),navController)
}
@Composable
@androidx.annotation.OptIn(androidx.media3.common.util.UnstableApi::class)
fun SplashScreen(uri:Uri, navController: NavHostController ){
    ...
    exoPlayer.addListener(object :Player.Listener{
        override fun onPlayerStateChanged(playWhenReady: Boolean, playbackState: Int) {
            when(playbackState){
                ...
                Log.e("exoplayer","video has ended")}
            }
        }
    })
    DisposableEffect(
